  ...
  return (
    <section className="relative pt-32 lg:pt-36">
      ...
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        ...
        >
          <h1 className="text-heading-1 text-3xl sm:text-3xl md:text-5xl xl:text-5xl font-bold">
          ...
          <Paragraph className="mt-8">
            Our digital solutions seamlessly integrate with your business to
            deliver engaging websites, powerful mobile apps, and streamlined
            workflows. Experience a future where your brand connects better,
            operates faster, and grows smarter.
          </Paragraph>
