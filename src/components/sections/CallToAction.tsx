        ...
        <div className="relative rounded-2xl overflow-hidden">
          <div className="relative z-10 mx-auto text-center max-w-xl md:max-w-2xl py-8 md:py-10 px-6 md:px-8">
            ...
            <Paragraph className="pt-10">
              Build your brand with tailor-made websites and mobile apps. We deliver seamless, scalable digital solutions designed to drive engagement and fuel growth.{" "}
            </Paragraph>
